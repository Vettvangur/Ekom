...
public class Configuration
{
    ...
    internal virtual Lazy<List<ICache>> CacheList { get; } = new Lazy<List<ICache>>(()
        => new List<ICache>
        {
            ...
            { Resolver.GetService<IPerStoreIndexedCache<ICategory>>() },
            { Resolver.GetService<IPerStoreCache<IProductDiscount>>() },
            { Resolver.GetService<IPerStoreIndexedCache<IProduct>>() },
            { Resolver.GetService<IPerStoreIndexedCache<IVariant>>() },
            { Resolver.GetService<IPerStoreIndexedCache<IVariantGroup>>() },
