...
namespace Ekom.Services
{
    public interface IMetafieldService
    {
        ...
        JArray SetMetafield(string json, string metaFieldAlias, List<MetafieldValues> values = null, string value = null);
        JArray SetMetafield(string json, Metafield field, List<MetafieldValues> values = null, string value = null);
