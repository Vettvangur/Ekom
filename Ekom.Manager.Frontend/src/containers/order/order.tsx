...
const PaidIndicatorWrapper = styled.div`
  display:flex;
  margin-top: 10px;
  span {
    margin-left: 8px;
              ...
              {order.PaidDate !== '0001-01-01T00:00:00' && order.PaidDate !== null
                ? (
                  <PaidIndicatorWrapper>
                    ...
                    <span style={{ color: variables.green }}>Paid</span>
                  </PaidIndicatorWrapper>
                )
                : (
                  <PaidIndicatorWrapper>
                    ...
                    <span style={{ color: variables.red }}>Unpaid</span>
                  </PaidIndicatorWrapper>
                )
          ...
          <OrderPaymentWrapper>
            <OrderPaymentColumns>
              <InformationColumn heading="Billing" list={[
                order.CustomerInformation.Customer !== null ? order.CustomerInformation.Customer.Name : null,
              ...
              {order.CustomerInformation.Shipping !== null &&
                <InformationColumn heading="Shipping" list={order.CustomerInformation.Shipping !== null && [
                  order.CustomerInformation.Shipping !== null && order.CustomerInformation.Shipping.Name.length > 0 && order.CustomerInformation.Shipping.Name,
