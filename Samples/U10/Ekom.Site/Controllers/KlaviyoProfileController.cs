...
public class KlaviyoProfileController : ControllerBase
{
        ...
        CancellationToken ct = default)
    {
        ...
        var listIds = await _profilesService.GetProfileListIdsByProfileIdAsync(profileId, storeAlias, ct);
        ...
        CancellationToken ct = default)
    {
        ...
        var payload = new KlaviyoProfileSubscribeRequest(
            StoreAlias: request.StoreAlias,
            Email: request.Email,
        ...
        CancellationToken ct = default)
    {
        ...
        var payload = new KlaviyoProfileUnsubscribeRequest(
            StoreAlias: request.StoreAlias,
            Email: request.Email);
